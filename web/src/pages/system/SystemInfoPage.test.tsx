...
it('toggles the system sidebar and exposes system config and usage in mobile navigation', async () => {
  let next = ''
  ...
  assert.ok(Array.from(dialog.querySelectorAll('[role="menuitem"]')).some(item => item.textContent?.includes('用量分析')))
